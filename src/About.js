...
const AboutScreen = ({ navigation }) => {
    ...
    <View style={{marginBottom:10}}>
      <Image source={require("../assets/my.jpg")} style={{width:"90%", height:400,margin:26,}}/>
    <Text style={{padding:10}}>What is lorem ipsum?
